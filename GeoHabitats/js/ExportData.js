...
function ExportData() {
    ...
    require([
        ...
        gp = new esri.tasks.Geoprocessor("http://barreto.md.ieo.es/arcgis/rest/services/UNESCO/ExtractDataTask2/GPServer/ExtractDataTask2");
        ...
        for (var i = 1; i < map.graphics.graphics.length; i++) {
            features.push(map.graphics.graphics[i]);
        }

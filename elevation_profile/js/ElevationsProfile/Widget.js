  ...
  return declare([_WidgetBase, _OnDijitClickMixin, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _initMeasureTool: function () {
      ...
      this.measureTool = new Measurement({
        map: this.map,
        defaultAreaUnit: (this.scalebarUnits === 'metric') ? Units.SQUARE_KILOMETERS : Units.SQUARE_KILOMETERS,
        defaultLengthUnit: (this.scalebarUnits === 'metric') ? Units.KILOMETERS : Units.KILOMETERS
      }, this._measureNode);
